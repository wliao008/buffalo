...
The Aspect Oriented Programming paradigm is first discussed in the 1997 paper ~\cite{aop}. When talk about AOP, the following terms are often mentioned.

pointcut - 
join point - 
aspect -

In it's most general form, AOP injects a piece of code into all relevant places in a program.

\section{Related Work}Like other paradigms, AOP is most effective and beneficial to programmers when it is supported on the compiler level, and make it a first class citizen like other properties of a language. Failing that, the next best thing is to have a framework to provide the support.
