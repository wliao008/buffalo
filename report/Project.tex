...
\reader{Prof. Matthew Fluet\\ Associate Professor}
\observer{Prof. Fereydoun Kazemian\\ Assistant Professor}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\vfill
%\begin{center}
I am grateful for my adviser Prof. Heliotis, whose insightful advices, guidance and support from the beginning enabled me to a better understanding of the project.
