...
Beside running from the command line, Buffalo can be hooked up with MS-Build, so post compilation weaving can be invoked automatically. Note that the instruction provided here are just the bare bond to get Buffalo going, a lot of bell and whistle are ommitted here.
